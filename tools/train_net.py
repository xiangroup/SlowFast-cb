...
def train_epoch(
    ...
    for cur_iter, (inputs, labels, _, meta) in enumerate(train_loader):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            # print('inputs1.len:', len(inputs[0]))
            # print('inputs1.size:', inputs[0].type())
            # print('inputs2.len:', len(inputs[1]))
            # print('inputs2.size:', inputs[1].type())
            # inputs.len: 2
            # inputs1.len: 16
            # inputs1.size: torch.cuda.FloatTensor
            # inputs2.len: 16
            # inputs2.size: torch.cuda.FloatTensor
            inputs1 = [inputs[0], ]
            inputs2 = [inputs[1], ]
            #print('inputs:', inputs)
            tymode = 'train'
        ...
        MI = -torch.mean(torch.log(ps_scores) + torch.log(1 - ns_scores))
